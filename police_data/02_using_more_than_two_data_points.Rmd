...
ggplot(data = csi_data, aes(x = REF_DATE, y = VALUE)) +
  ...
  labs(title = "Total Crime Severity Index",
       ...
       x = "Year",
       y = "Total CSI",
       caption = "Based on Statistics Canada, Crime Severity Index and Weightd Clearance Rates")
```
