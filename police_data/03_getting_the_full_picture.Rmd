...
increase_decrease_data = reported_crime_data %>%
  filter(!grepl("Total", Violations) & Statistics == "Percentage change in rate") %>%
...
Since the number of violations tracked in the dataset has been constant at 266 since 2015, we'll do this analysis using only data from 2015 and later. Create a dataset showing the percentage of violations that saw a year-over-year increase (or staying the same) for each year since 2015:
```{r}
...
ggsave("./increase_decrease_distribution_2015_2021.jpg", device = "jpeg")
ggsave("./increase_decrease_distribution_2015_2021_feature.jpg", device = "jpeg", width = 2400, height = 1200, units = "px")
ggsave("./increase_decrease_distribution_2015_2021_twitter.jpg", device = "jpeg", width = 2400, height = 1254, units = "px")
```
